...
public:
    ...
    void setupUi(QMainWindow *HAT)
    {
        ...
        pegatabela->setGeometry(QRect(140, 70, 151, 41));
    ...
    void retranslateUi(QMainWindow *HAT)
    {
        ...
        HAT->setToolTip(QApplication::translate("HAT", "<html><head/><body><p>cfdsfdsf</p></body></html>", 0));
#endif // QT_NO_TOOLTIP
